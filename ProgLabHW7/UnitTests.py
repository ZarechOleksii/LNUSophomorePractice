...
class TestHW7(unittest.TestCase):
    ...
    def test_collection_sort_write(self):
        ...
        test_collection.sorting2('title')
        ...
        test_collection.sorting2('rest_name')
        test_collection.rewrite()
        ...
        test_collection.sorting2('duration')
        test_collection.rewrite()
        ...
        test_collection.sorting2('price')
        test_collection.rewrite()
